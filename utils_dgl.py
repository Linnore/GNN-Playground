...
def add_train_parser(subparsers: argparse._SubParsersAction, parent_parser: argparse.ArgumentParser, config: config_dgl):
...
def add_inference_parser(subparsers: argparse._SubParsersAction, parent_parser: argparse.ArgumentParser, config: config_dgl):
    parser = subparsers.add_parser(
...
def add_evaluate_parser(subparsers: argparse._SubParsersAction, parent_parser: argparse.ArgumentParser, config: config_dgl):
    parser = subparsers.add_parser(
...
def create_parser(config: config_dgl):
